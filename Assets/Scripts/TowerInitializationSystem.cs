...
public partial struct TowerInitializationSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (tower, transform, bulletBuffer, entity) in SystemAPI.Query<RefRO<TowerData>, RefRO<LocalTransform>, DynamicBuffer<TowerBulletElement>>().WithEntityAccess())
        {
